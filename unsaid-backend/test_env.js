...
function coerce(val, type) {
  ...
  switch (type) {
    ...
    case 'array': return String(val).split(',').map((s) => s.trim()).filter(Boolean);
...
console.log('About to create exports object...');
const exports = {
  nodeEnv,
  isProd,
  isDev,
...
console.log('Keys:', Object.keys(exports));
console.log('nodeEnv:', exports.nodeEnv);
console.log('service:', exports.service);
