...
class PersonalityDrivenAnalyzer extends ChangeNotifier {
  ...
  final RelationshipInsightsService _relationshipService =
  ...
  Map<String, dynamic> _getPersonalityProfile(String personalityType) {
    final profiles = {
      'A': {
        ...
        'primary_color': Color(0xFFFF1744),
        'secondary_color': Color(0xFFFFCDD2),
      ...
      'B': {
        ...
        'primary_color': Color(0xFF4CAF50),
        'secondary_color': Color(0xFFC8E6C9),
      ...
      'C': {
        ...
        'primary_color': Color(0xFF2196F3),
        'secondary_color': Color(0xFFBBDEFB),
      ...
      'D': {
        ...
        'primary_color': Color(0xFFFF9800),
        'secondary_color': Color(0xFFFFE0B2),
