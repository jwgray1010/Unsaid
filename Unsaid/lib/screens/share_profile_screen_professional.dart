...
class _ShareProfileScreenProfessionalState
  ...
  final String yourType = 'Secure Attachment';
  final String yourComm = 'Assertive'; // Communication style
  final String partnerType = 'Dismissive Avoidant';
...
''';
                ...
                child: Row(
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        padding: EdgeInsets.all(theme.spaceSM),
                        decoration: BoxDecoration(
  ...
  Widget _buildPreviewDialog(AppTheme theme) {
    return Dialog(
