                ...
                children: [
                  ElevatedButton.icon(
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const SecureCoupleTips()),
                    ),
                    icon: const Icon(Icons.tips_and_updates, semanticLabel: 'Tips'),
                    label: const Text("View Secure Communication Tips"),
