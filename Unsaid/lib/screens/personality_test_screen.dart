...
class PersonalityTestScreen extends StatefulWidget {
  ...
  final void Function(MergedConfig config, AttachmentScores scores,
      GoalRoutingResult routing)? onComplete;
...
class _PersonalityTestScreenState extends State<PersonalityTestScreen> {
  ...
  Future<void> _completeTest() async {
    ...
    try {
      ...
      if (widget.onComplete != null) {
        widget.onComplete!(
            mergedConfig, assessmentResult.scores, assessmentResult.routing);
      }
                                ...
                                children: [
                                  ...
                                  if (question.isGoal &&
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:
                                            questionTypeColor.withOpacity(0.2),
                                        borderRadius: BorderRadius.circular(8),
                                      ),
                                      child: Text(
  ...
  static void startAssessment(
    ...
    void Function(MergedConfig config, AttachmentScores scores,
