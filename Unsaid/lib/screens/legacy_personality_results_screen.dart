...
class LegacyPersonalityResultsScreen extends StatefulWidget {
  final List<String> answers;
  final List<String>?
      communicationAnswers; // Optional: pass communication answers

  const LegacyPersonalityResultsScreen({
    super.key,
  ...
  @override
  State<LegacyPersonalityResultsScreen> createState() =>
      _LegacyPersonalityResultsScreenState();
}

class _LegacyPersonalityResultsScreenState
    extends State<LegacyPersonalityResultsScreen>
